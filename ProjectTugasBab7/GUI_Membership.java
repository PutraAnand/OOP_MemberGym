...
public class GUI_Membership extends javax.swing.JFrame {
    ...
    public GUI_Membership() {
        initComponents();
        String[] kolom = {"Nama", "Id Member", "Level", "Trainer"};
    ...
    MemberGym member = new MemberRegular(nama, id, level, trainer);
    ...
    model.addRow(new Object[] {
        ...
        (member instanceof MemberRegular) ? ((MemberRegular) member).getTrainer() : "-"
    });
